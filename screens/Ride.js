...
export default class RideScreen extends Component {
  ...
  initiateBicycleIssue = (bikeId, userId, bikeName, userName) =>{
    ...
    db.collection("users").doc(userId).update({
      number_of_bikes_issued : firebase.firestore.FieldValue.increment(1)
   ...
   console.log("Bicycle issued to the user") 
  }

  initiateBikeReturn = async (bikeId, userId, bikeName, userName) => {
    //add a transaction
    db.collection("transactions").add({
      u_id: userId,
      name: userName,
